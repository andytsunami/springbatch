...
public class ParImparBatchConfig {
    ...
    @Bean
    public Job imprimePaImparJob(){
        return jobBuilderFactory.get("imprimePaImparJob")
                .start(imprimePaImparStep())
                .incrementer(new RunIdIncrementer()).build();
    }

    public Step imprimePaImparStep() {
        return stepBuilderFactory
                .get("imprimePaImparStep")
